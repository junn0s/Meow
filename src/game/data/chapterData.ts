...
/** Each restaurant begins where the previous chapter's late-game unit band ended. */
export const CHAPTER_ECONOMY_SCALES: Readonly<Record<ChapterId, number>> = Object.freeze({
  1: 1,
  2: 1e9,
  3: 1e18,
  4: 1e27,
